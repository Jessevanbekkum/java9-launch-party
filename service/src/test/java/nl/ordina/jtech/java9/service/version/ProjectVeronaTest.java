...
public class ProjectVeronaTest {
    ...
    public void shouldGetParsableVersionNumbers() {
        ...
        assertTrue(System.getProperty("java.version").contains("9"));
        assertTrue(System.getProperty("java.runtime.version").contains("9"));
        assertTrue(System.getProperty("java.specification.version").contains("9"));
        assertTrue(System.getProperty("java.vm.specification.version").contains("9"));
    }
}
